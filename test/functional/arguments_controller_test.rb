...
class ArgumentsControllerTest < ActionController::TestCase
  ...
  test "should create argument" do
    assert_difference('Argument.count') do
      post :create, argument: { description: @argument.description, title: @argument.title, user_id: @argument.user_id }
    end
  ...
  test "should update argument" do
    put :update, id: @argument, argument: { description: @argument.description, title: @argument.title, user_id: @argument.user_id }
    assert_redirected_to argument_path(assigns(:argument))
  end
